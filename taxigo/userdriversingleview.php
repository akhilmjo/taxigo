...
$sql="SELECT * FROM `registration` WHERE `reg_id`=$rid";
 $result=mysqli_query($con,$sql);
 $row=mysqli_fetch_array($result);
 //SELECT `reg_id`,`fname`, `lname`, `phno`, `photo`, `emailid`, `Dob`, `gender`, `Address`, 
?>						 
<h1 style="color:white">Driver Info</h1>
...
<form name="myform" action="#" method="post">
    ...
    <tr><td><p style="color:white">Id:</p></td><td style="color:red;"><?php echo $row['reg_id']?></td></tr>
    <tr><td><p style="color:white">Name:</p></td><td style="color:red;"><?php echo $row['fname']?> <?php echo $row['lname']?></td></tr>
    <tr><td><p style="color:white">Phone No:</p></td><td style="color:red;"><?php echo $row['phno']?></td></tr>
    <tr><td><p style="color:white">Email id:</p></td><td style="color:red;"><?php echo $row['emailid']?></td></tr>
    <tr><td><p style="color:white">Dob:</p></td><td style="color:red;"><?php echo $row['Dob']?></td></tr>
    <tr><td><p style="color:white">Gender:</p></td><td style="color:red;"><?php echo $row['gender']?></td></tr>
    <tr><td><p style="color:white">Address:</p></td><td style="color:red;"><?php echo $row['Address']?></td></tr>
		
    <td style="margin-top:3%; margin-left:20%; color:blue; padding:10%;"><a href="<?php echo $page?>" class="btn btn-primary">back</a></td>
  </dl>
    </form>
