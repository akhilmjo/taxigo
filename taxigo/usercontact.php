...
<body onload="myMap();">
	...
	<h1 style="color:white; margin-top:-27%; margin-left:-60%;">About Us</h1>
	<div style="margin-left:30%; width:30%; height:40%;">
	<p style="color:white; margin-left:-150%;">
Mob: 8281306327 / +91 9605 322 371</p>
<span style="color:white; margin-left:-150%;">Email: taxigo950@gmail.com</p>
<p style="color:white; margin-left:-150%;">White Way Building</p>
<p style="color:white; margin-left:-150%;">Door No: XII-627/2</p>
<p style="color:white; margin-left:-150%;">Near Amal jyothi college koovappally,kanjirappally,</p>
<p style="color:white; margin-left:-150%;">Kottayam. Pincode - 656518
	</p>
	</div>
	<div id="map" style="border:2px solid white; width:50%; height:300px; margin-left:50%; margin-top:-20%;">
	</div>
		</div>
		<script>
function myMap() {
  var myCenter = new google.maps.LatLng(9.5398579,76.8027054);
...
<script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyB1ypVDGm8lr-4DB9Rk-c2YJXq1ormSRIs&callback=myMap"></script>
		...
		<!--Testimonial-->
<section class="row testimonial-row" style="margin-top:-30%;">
	<div class="container"> 
<?php
