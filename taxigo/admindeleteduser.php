...
<body>
	...
	<div class="div4">
<div class="div1">
<h1 style="color:white; margin-left:-15%;">DELETED USER DETAlLS</h1>
<?php 
$tid=$_SESSION['id'];
$sql="SELECT * FROM `registration` WHERE `type_id`=2  and `status`=1";
$result=mysqli_query($con,$sql);
...
<form name="myform" action="adminuseredit.php" method="post" >

    <tr><td><p style="color:white">Fname:</p></td><td><input style="color:#f77d0a" type="text" id="fn" name="firstname" value="<?php echo $row['fname']?>" disabled required></td>
	<td><p style="color:white">Lname:</p></td><td><input style="color:#f77d0a" type="text" name="lastname" value="<?php echo $row['lname']?>" disabled required></td></tr>
    <tr><td><p style="color:white">phone_no:</p></td><td><input style="color:#f77d0a" type="text" id="ph" name="contact" value="<?php echo $row['phno']?>" disabled required></td>
	...
	<tr><td><p style="color:white">Dob:</p></td><td><input style="color:#f77d0a" type="date" id="demo1" name="dob" value="<?php echo $row['Dob']?>"disabled></td>
    <td><p style="color:white">Gender:</p></td><td><input style="color:#f77d0a" type="text" name="gender" value="<?php echo $row['gender']?>" disabled></td></tr>
	<tr><td><p style="color:white">Address:</p></td><td><input style="color:#f77d0a" type="text" name="addres" value="<?php echo $row['Address']?>" disabled required></td>
	<td><p style="color:white">Id no:</p></td><td><input style="color:#f77d0a" type="text" id="aaa" name="idno" value="<?php echo $row['idproofno']?>" disabled required></td></tr>
    <input style="color:#f77d0a" type="hidden" name="sid1" value="<?php echo $row['reg_id']?>"/>
	
    
     <td style="margin-top:3%; margin-left:15%; color:blue;"><input type="submit" name="update" value="Restore"></td>
   </dl>
