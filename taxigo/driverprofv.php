...
<form name="myform" action="driverprofedit.php" method="post">

    <tr><td><p style="color:white">Fname:</p></td><td><input style="color:#f77d0a" type="text" name="firstname" value="<?php echo $row['fname']?>"></td></tr>
	<tr><td><p style="color:white">Lname:</p></td><td><input style="color:#f77d0a" type="text" name="lastname" value="<?php echo $row['lname']?>"></td></tr>
