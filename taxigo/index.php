...
<body>
	...
	<section class="slide-banner row">
		...
		<div class="this-texts container">
			...
			<h2 class="this-h1">Now available at kerala<!--<img src="images/availablity.png" alt="">--></h2>
			<h2 class="this-foot">8281 - 306 - 327</h2>
			<a href="login.php" class="btn btn-primary">Let’s check it out</a>
		</div>
