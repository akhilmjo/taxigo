...
$date="$date3 $v";
$logid=$_SESSION['id'];
$sql1="SELECT * FROM `taxi_booking` where `from_datetime`>'$date' and `login_id`='$logid' and `cancel_st`='0'";
...
<form action="user_book_cancel.php" method="post">
<td><input type="hidden" name="bid" value="<?php echo $fetch["bk_id"];?>"></td>
