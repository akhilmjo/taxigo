...
<body>
	...
	<div class="div4">
<div class="div1">
<h1 style="color:white; margin-left:-15%;">ACTIVE DRIVER DETAlLS</h1>
<?php 
$tid=$_SESSION['id'];
$sql="SELECT * FROM `registration` WHERE `type_id`=3 and `status`=0";
$result=mysqli_query($con,$sql);
$d='adminviewdriver.php';
$i=0;
...
<form name="myform" action="admindriveredit.php" method="post">
	...
	<tr><td><p style="color:white">Dob:</p></td><td><input style="color:#f77d0a" type="date" name="dob" value="<?php echo $row['Dob']?>"></td>
    ...
    <input style="color:#f77d0a" type="hidden" name="sid1" value="<?php echo $row['reg_id']?>"/>
     ...
     <td style="margin-top:3%; margin-left:5%; color:blue;"><?php echo "<a style='color:blue;' href=admin_driveredit.php?rid=",$row['reg_id'],"&page=",$d,">Edit</a>" ?></td>
