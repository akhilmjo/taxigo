...
<input name="key" type="hidden" value="1"/> 
                            ...
                            <div class="table-responsive" style="width:97%; margin-left:3%; overflow:scroll; height:500px; ">
							  ...
							  <tbody>
							  <?php
// `fed_id`, `reg_id`, `ratting`, `message`, `status`
...
while($fetch=mysqli_fetch_array($result)){
	...
	$sql6="SELECT * FROM `registration` WHERE `reg_id`='$rid'";	
...
<tr>
<td><?php echo $fetch6["fname"];?></td>
<td><?php echo $fetch["ratting"];?></td>
...
?>
<form method="post" action="admin_fed_ap_con.php">
<input type="hidden" name="id" value="<?php echo $fetch["fed_id"];?>">
...
?>
<form method="post" action="admin_fed_ap_con.php">
<input type="hidden" name="id1" value="<?php echo $fetch["fed_id"];?>">
<select style="color:green;"  name="apr1"  onchange="this.form.submit();">
<option style="color:green;">Approve</option>
<option >Reject</option>
</select>
</form>
