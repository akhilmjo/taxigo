...
<form name="myform" action="adminuseredit.php" method="post">
    ...
    <tr><td><p style="color:white">Fname:</p></td><td><input style="color:#f77d0a" id="fn"   onchange="return n11();"type="text" name="firstname" value="<?php echo $row['fname']?>" required></td></tr>
	<tr><td><p style="color:white">Lname:</p></td><td><input style="color:#f77d0a" type="text" name="lastname" value="<?php echo $row['lname']?>" required></td></tr>
    <tr><td><p style="color:white">phone_no:</p></td><td><input style="color:#f77d0a" id="ph" type="text" name="contact" value="<?php echo $row['phno']?>" onchange="return phn();" required></td></tr>
	<tr><td><p style="color:white">Email:</p></td><td><input style="color:#f77d0a" id="em1" type="text" name="Email" value="<?php echo $row['emailid']?>" onchange="return em();" required></td></tr>
	<tr><td><p style="color:white">Dob:</p></td><td><input style="color:#f77d0a; width:100%;" type="date" id="demo" name="dob" value="<?php echo $row['Dob']?>" required></td></tr>
    <tr><td><p style="color:white">Gender:</p></td><td><input style="color:#f77d0a" type="text" name="gender" value="<?php echo $row['gender']?>"disabled></td></tr>
	...
	<tr><td><p style="color:white">Id no:</p></td><td><input style="color:#f77d0a" id="aaa" type="text" name="idno" value="<?php echo $row['idproofno']?>" onchange="return aadh();" required></td></tr>
