...
<body>
	...
	<div class="div4">
<div class="div1">
<h1 style="color:white; margin-left:-15%;">DELETED DRIVER DETAlLS</h1>
<?php 
$tid=$_SESSION['id'];
$sql="SELECT * FROM `registration` WHERE `type_id`=3 and `status`=1";
$result=mysqli_query($con,$sql);
...
<form name="myform" action="admindriveredit.php" method="post">
    ...
    <tr><td><p style="color:white">Fname:</p></td><td><input style="color:#f77d0a" type="text" name="firstname" value="<?php echo $row['fname']?>" disabled></td>
	<td><p style="color:white">Lname:</p></td><td><input style="color:#f77d0a" type="text" name="lastname" value="<?php echo $row['lname']?>" disabled></td></tr>
    <tr><td><p style="color:white">phone_no:</p></td><td><input style="color:#f77d0a" type="text" name="contact" value="<?php echo $row['phno']?>" disabled></td>
	...
	<tr><td><p style="color:white">Dob:</p></td><td><input style="color:#f77d0a" type="text" name="dob" value="<?php echo $row['Dob']?>" disabled></td>
	...
	<tr><td><p style="color:white">Address:</p></td><td><input style="color:#f77d0a" type="text" name="addres" value="<?php echo $row['Address']?>" disabled></td>
	<td><p style="color:white">Id no:</p></td><td><input style="color:#f77d0a" type="text" name="idno" value="<?php echo $row['idproofno']?>" disabled></td></tr>
    <input style="color:#f77d0a" type="hidden" name="sid1" value="<?php echo $row['reg_id']?>"/>
	
    
     <td style="margin-top:3%; margin-left:15%; color:blue;"><input type="submit" name="update" value="Restore" onclick="return checkDelete()"></td>
   </dl>
    </form>
	</table>
	<div class="divp">
