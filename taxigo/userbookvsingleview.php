...
?>						 
<h1 style="color:white">Vehicle Info</h1>
...
<form name="myform" action="#" method="post">
    ...
    <tr><td><p style="color:white">Id:</p></td><td style="color:red;"><?php echo $row['vid']?></td></tr>
    <tr><td><p style="color:white">Name:</p></td><td style="color:red;"><?php echo $row['vname']?></td></tr>
    <tr><td><p style="color:white">Reg No:</p></td><td style="color:red;"><?php echo $row['vregno']?></td></tr>
    <tr><td><p style="color:white">Seat No:</p></td><td style="color:red;"><?php echo $row['vseatno']?></td></tr>
    <tr><td><p style="color:white">Model:</p></td><td style="color:red;"><?php echo $row['vmodel']?></td></tr>
