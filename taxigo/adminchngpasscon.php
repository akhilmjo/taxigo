...
{
	echo "<script>if(confirm('username and password are enterd incorrect!!')){document.location.href='adminchngpass.phpuserchngepass.php'}else{document.location.href='adminhome.php'};</script>";
	
}
}
else
{
	echo "<script>if(confirm('new password are mismatch!!')){document.location.href='adminchngpass.php'}else{document.location.href='adminhome.php'};</script>";
