...
<body>
	...
	<h1 style="color:white margin-left:0%">log in</h1>
		...
		<div class="login-form">
			<div class="sign-in-htm">
				<div class="group">
					...
					<input id="user1" type="text" class="input" name="user" value="<?php if(isset($_COOKIE['user'])){echo $_COOKIE['user']; }?>">
				</div>
				<div class="group">
					<label for="pass" class="label">Password</label>
					<input id="pass1" type="password" class="input" data-type="password" name="pass" value="<?php if(isset($_COOKIE['user'])){echo $_COOKIE['pass'];} ?>">
				</div>
				</br>
				<div style="margin-left:20%" class="g-recaptcha" data-sitekey="6LeCAC4UAAAAACHcHsH4s_oRTGPbJPS2Biq_gFQc"></div>
				<div class="group">
				...
				<div class="hr"></div>
				<div class="foot-lnk" style="margin-top:-7%;">
					<a href="forgotpassd.php">Forgot Password?</a>
				</div>
			</div>
		</div>
		</div>
