...
<h2 style="color: black">EMPLOYEE DETAILS</h2><br><br><br><br><br><br><br>
<?php
include 'dbcon.php';
...
<tr><th>ID</th><th>name</th><th>DESIGNATION</th><th>PHONE</th><th>EMAIL</th><th>ADD</th><th>DELETE</th></tr>
<?php
$sql="SELECT * FROM `empreg` where status='0'";
...
while($row=mysqli_fetch_array($result))
{
	...
	<td><?php echo $row['Email'] ?></td>
	 <form action="addloginemp.php" method="post">
