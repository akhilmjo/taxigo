...
<body>
	...
	<section class="slide-banner row">
		...
		<h3 style="color:pink;margin-left:48%; margin-top:-2%;">DRIVER REGISTRATION</h3><br />								
      			<form action="driverreg.php" method="post" enctype="multipart/form-data" name="form1" id="form1" onsubmit="return val();">
					<table style="width:100%; cellpadding:5%; margin-left:50%;margin-top:-2%;">
						...
						<tr><td> Date Of Birth<span style="color:red;">*</span>:</td> <td><input  id="demo" type="text" name="dob" style="width:237px;" required></td></tr>
						...
						<tr><td>photo<span style="color:red;">*</span>:</td><td><input name="photo" type="file" id="ufile" size="50" onchange="fileCheck(this);" required style="margin-left:28%"/></td></tr><tr></tr>												
						<tr><td> Address<span style="color:red;">*</span>:</td> <td><input type="textarea" rows="10" cols="70" name="address" style="width:45%;" required ></td></tr>
						...
						<tr><td> AAdhar proof<span style="color:red;">*</span>:</td> <td><input name="photo2" type="file" id="ufile1" size="50" onchange="ff11(this);" required  style="margin-left:28%"/></td></tr>
						<tr><td> licence no<span style="color:red;">*</span>:</td> <td><input type="text" id="lno" name="idno1" required  onchange="return lice();"></td></tr>
						<tr><td> licence proof<span style="color:red;">*</span>:</td> <td><input name="photo3" type="file" id="ufile2" size="50" onchange="ff22(this);" required style="margin-left:28%"></td></tr>
						</table>
						<table style="width:-5%; margin-left:128%;margin-top:-40%;"><tr><td><button class="btn btn-primary btn-block" name="submit">Register >></button></td></tr></table>	
                    </form>
					</div>
	</section>
